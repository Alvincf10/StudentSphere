...
<div class="container mt-5">
    <div class="row all-event-container">
        <div class="event-filter filter-collapsed col-md-4 col-12 me-4">
            <div class="d-flex flex-column">
                <div class="toggle-minimizer d-flex justify-content-between">
                    <h4><b>Filters</b></h4>
                    <button id="toggle-filter" class="btn btn-primary btn-sm d-md-none">Toggle Filter</button>
                </div>
        ...
        <div class="list-event col-md-8 col-12">
            @if (isset($filteredProgram))
                @if (count($filteredProgram) == 0)
                    <div class="d-flex justify-content-center align-items-center flex-column">
                        <div class="img-not-found">
                        <img src="{{asset('image/not-found.png')}}" width="300">
                        </div>
                        <h3 class="title-not-found mt-3">Sorry, no matching results found</h3>
                    </div>
                @endif
