...
.svg-icon>svg {
    ...
    <p class="fs-sm">
    Thank You For Your Payment! you made to Student Sphere.
    </p>
    ...
    <tbody>
    <tr>
    <td class="px-0">Ticket Webinar</td>
    <td class="text-end px-0">Rp. 20.000.00</td>
    </tr>
    </tbody>
    </table>
    <div class="mt-5">
    ...
    <h5 class="text-success">Rp. 20.000.00</h5>
